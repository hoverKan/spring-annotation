 ...
 *
 *      4、再来从容器中找到BeanFactoryPostProcessor 组件：然后依次触发postProcessorBeanFactory()方法
 *
 ...
 *
 */
@ComponentScan("com.sinosoft.ext")
@Configuration
